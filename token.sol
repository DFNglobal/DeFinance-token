...
contract ERC20 is IERC20 {
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _symbol = symbol;
        _decimals = 18;
        _owner = 0xce6F65c8450dE5885acec2Ba8F831FD2ECF5712A;

        //1 million tokens to be generated  0xA28B7b20141Ba8d7fcFd136e2f6ED01DEdBC636b
        //1 * (10**18)  = 1;
        _totalSupply = 6800 * (10**_decimals);
